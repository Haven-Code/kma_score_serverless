...
export const protobufPackage = "KmaScheduleCrawlerProto";
...
export type KmaScheduleCrawlerServiceService = typeof KmaScheduleCrawlerServiceService;
export const KmaScheduleCrawlerServiceService = {
  getSemesterList: {
    path: "/KmaScheduleCrawlerProto.KmaScheduleCrawlerService/GetSemesterList",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetSemesterListReq) => Buffer.from(GetSemesterListReq.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetSemesterListReq.decode(value),
    responseSerialize: (value: GetSemesterListRsp) => Buffer.from(GetSemesterListRsp.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetSemesterListRsp.decode(value),
  },
  getScheduleByStudentCode: {
    path: "/KmaScheduleCrawlerProto.KmaScheduleCrawlerService/GetScheduleByStudentCode",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetScheduleByStudentCodeReq) =>
      Buffer.from(GetScheduleByStudentCodeReq.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetScheduleByStudentCodeReq.decode(value),
    responseSerialize: (value: GetScheduleByStudentCodeRsp) =>
      Buffer.from(GetScheduleByStudentCodeRsp.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetScheduleByStudentCodeRsp.decode(value),
  },
} as const;

export interface KmaScheduleCrawlerServiceServer extends UntypedServiceImplementation {
  getSemesterList: handleUnaryCall<GetSemesterListReq, GetSemesterListRsp>;
  getScheduleByStudentCode: handleUnaryCall<GetScheduleByStudentCodeReq, GetScheduleByStudentCodeRsp>;
}

export interface KmaScheduleCrawlerServiceClient extends Client {
  getSemesterList(
    request: GetSemesterListReq,
    callback: (error: ServiceError | null, response: GetSemesterListRsp) => void,
  ): ClientUnaryCall;
  getSemesterList(
    request: GetSemesterListReq,
    metadata: Metadata,
  ...
  getScheduleByStudentCode(
    ...
    callback: (error: ServiceError | null, response: GetScheduleByStudentCodeRsp) => void,
  ): ClientUnaryCall;
  getScheduleByStudentCode(
    request: GetScheduleByStudentCodeReq,
    metadata: Metadata,
...
export const KmaScheduleCrawlerServiceClient = makeGenericClientConstructor(
  KmaScheduleCrawlerServiceService,
  "KmaScheduleCrawlerProto.KmaScheduleCrawlerService",
) as unknown as {
  new (
    address: string,
  ...
  service: typeof KmaScheduleCrawlerServiceService;
  serviceName: string;
};
